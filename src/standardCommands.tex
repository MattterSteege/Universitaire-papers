...
\NewDocumentCommand{\TableRow}{m m}{%
    \textbf{#1} & #2 \\
    \arrayrulecolor{black!10}\specialrule{0.5pt}{1pt}{0pt}\arrayrulecolor{black!100}
}
...
\NewDocumentCommand{\TableClearRow}{m m}{%
    \textbf{#1} & \textbf{#2} \\
}
\NewDocumentCommand{\TableClearRowThree}{m m m}{%
