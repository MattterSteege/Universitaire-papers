...
\begin{document}
    ...
    \begin{table}[h]
        ...
        \resizebox{\columnwidth}{!}{%
            \begin{tabular}{ll}
                ...
                \textbf{Uitsluiting / “Wie hoort hier?”}  & \begin{tabular}[c]{@{}l@{}}Bewaking stimuleert raciale en sociale profilering:\\ wie “past” er wel of niet in de buurt?\end{tabular} \\
    ...
    De auteurs laten zien hoe al deze problemen elkaar versterken.
    Bedrijfswinsten, angst voor criminaliteit, slimme marketing (“voel je veilig, wees een goede buur”) en raciale vooroordelen werken allemaal als motoren in hetzelfde systeem.
    ...
    \begin{itemize}
        \item \textbf{Surveillance als normaal onderdeel} van huis en buurt.
        \item \textbf{Meer macht voor de politie}, via private datastromen.
        \item \textbf{Grotere ongelijkheid}, omdat gemarginaliseerde groepen vaker worden bekeken of verdacht.
        \item \textbf{Minder democratische controle}, want niemand houdt toezicht op wat er precies gebeurt.
    \end{itemize}

    Hun eindpunt is scherp:
    Amazon Ring is een voorbeeld van een technologie die \textbf{niet te hervormen is}.
    De problemen zitten ingebakken in hoe het werkt en in de sociale logica eromheen.
    Volgens Selinger en Durant helpt geen privacysetting of toestemmingsformulier meer — sommige technologieën, zeggen ze, \textbf{zouden gewoon niet moeten bestaan}.
