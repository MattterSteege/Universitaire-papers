...
\begin{document}
    ...
    \section{Introductie}
    \spliteveryn{20}{This is an example of splitting text into multiple lines every n characters.}
    ...
    \begin{table}[h]
        ...
        \resizebox{\columnwidth}{!}{%
            \begin{tabular}{ll}
                \hline
                \textbf{Categorie} & \textbf{Belangrijkste bevindingen en verbeterpunten} \\ \hline
                \textbf{Android-applicatie} & \begin{tabular}[c]{@{}l@{}}Gevoelige data kan uitlekken bij een geroot toestel doordat de app-data niet goed wordt afgeschermd.\\
                Externe opslag moet worden vermeden en verouderde encryptie vervangen.\\
                Certificaatvalidatie is zwak (zelfondertekende certificaten worden te snel vertrouwd)\\
                en logging is minimaal. Positief is dat de code lastig te manipuleren is door de gesegmenteerde \texttt{.dex}-bestanden.\end{tabular} \\[0.4em]
                \textbf{Accountbeveiliging} & \begin{tabular}[c]{@{}l@{}}Wachtwoorden worden gehasht met MD5, wat onveilig is en makkelijk te breken.\\
                Sessies worden in URL’s doorgegeven in plaats van via veilige cookies of POST-methoden.\\
                CAPTCHA’s beperken brute-force aanvallen effectief en het wachtwoordbeleid is voldoende streng.\end{tabular} \\[0.4em]
                \textbf{Draadloze communicatie} & \begin{tabular}[c]{@{}l@{}}Verkeer tussen app en deurbel verloopt via HTTPS, waardoor afluisteren bemoeilijkt wordt.\\
                Toch blijft een MitM-aanval mogelijk als de aanvaller een eigen CA weet te installeren.\\
                Replay-aanvallen zijn theoretisch uitvoerbaar bij specifieke verzoeken (zoals uitloggen of gebruikers delen).\\
                Deauthenticatie-aanvallen kunnen de deurbel tijdelijk uitschakelen en zelfs helpen bij het kraken van het Wi-Fi-wachtwoord.\end{tabular} \\ \hline
            \end{tabular}%
        }
        \caption{Overzicht van de belangrijkste beveiligingsbevindingen van de smart video deurbel.}
        \label{tab:doorbell-findings}
    \end{table}
    ...
    \begin{table}[h]
        ...
        \resizebox{\columnwidth}{!}{%
            \begin{tabular}{ll}
                \hline
                \textbf{Aspect} & \textbf{Beschrijving} \\ \hline
                \textbf{Probleemstelling} & \begin{tabular}[c]{@{}l@{}}Bestaande beveiligingssystemen vertrouwen enkel op gezichtsherkenning;\\ onbekende gezichten worden niet gecontroleerd of gemeld.\end{tabular} \\

                \textbf{Doel van het systeem} & \begin{tabular}[c]{@{}l@{}}Ontwikkelen van een slimme deurbel die gebruikmaakt van IoT,\\ gezichtsherkenning, stemherkenning en bewegingsdetectie\\ om bezoekers automatisch te identificeren.\end{tabular} \\

                \textbf{Werking} & \begin{tabular}[c]{@{}l@{}}Bij het aanbellen activeert de Raspberry Pi een camera; de foto wordt vergeleken\\ met een database van geregistreerde gezichten. Onbekende bezoekers leiden tot\\ een e-mailmelding met foto en OTP naar de eigenaar.\end{tabular} \\

                \textbf{Technologieën} & \begin{tabular}[c]{@{}l@{}}Raspberry Pi, OpenCV (beeldverwerking), DSP (stemherkenning),\\ Speech-to-Text, e-mailserver voor OTP-verzending.\end{tabular} \\

                \textbf{Innovatie t.o.v. bestaande systemen} & \begin{tabular}[c]{@{}l@{}}Combinatie van gezichtsherkenning, stemverificatie en OTP-bevestiging;\\ ondersteunt ook bewegingsdetectie om indringers te herkennen\\ die niet aanbellen.\end{tabular} \\

                \textbf{Verwachte resultaten} & \begin{tabular}[c]{@{}l@{}}97\% nauwkeurigheid bij gezichtsherkenning, 98\% bij stemherkenning,\\ lage energieconsumptie en realtime detectie van verdachte bewegingen.\end{tabular} \\

                \textbf{Conclusie} & \begin{tabular}[c]{@{}l@{}}Een geïntegreerd IoT-beveiligingssysteem dat autonoom werkt,\\ indringers detecteert en eigenaars in realtime waarschuwt —\\ geschikt voor de verdere ontwikkeling van slimme huizen.\end{tabular} \\ \hline
            \end{tabular}%
        }
        \caption{Overzicht van de belangrijkste elementen uit \textit{Smart Doorbell Security System Using IoT}.}
        \label{tab:doorbell}
    \end{table}
