...
\begin{document}
    ...
    \subsection{}
    \editorsonly{Type bron: theoretisch kader dat voorspelt wanneer slimme stadstechnologieën privacyzorgen oproepen.}
    ...
    \figure[ht]
    %\graphicspath{{../images/}} import the SmartCityPrivacy.png from the images folder
        \centering
