...
%    {tab:doorbell}
%    {
%        \SimpleTableHeader{Aspect}{Beschrijving}
%        \SimpleTableRow{Probleemstelling}{Bestaande beveiligingssystemen vertrouwen enkel op gezichtsherkenning; onbekende gezichten worden niet gecontroleerd of gemeld.}
%        \SimpleTableRow{Doel van het systeem}{Ontwikkelen van een slimme deurbel die gebruikmaakt van IoT, gezichtsherkenning, stemherkenning en bewegingsdetectie om bezoekers automatisch te identificeren.}
%        \SimpleTableRow{Werking}{Bij het aanbellen activeert de Raspberry Pi een camera; de foto wordt vergeleken met een database van geregistreerde gezichten. Onbekende bezoekers leiden tot een e-mailmelding met foto en OTP naar de eigenaar.}
%        \SimpleTableRow{Technologieën}{Raspberry Pi, OpenCV (beeldverwerking), DSP (stemherkenning), Speech-to-Text, e-mailserver voor OTP-verzending.}
%    }
%    {2}
    ...
    \editorsonly{Type bron: Kritische analyse van Amazon's Ring-ecosysteem en de marketing van Ring-deurbellen; hoe deze technologie sociale problemen veroorzaakt en ethische dilemma's oproept.}
    ...
    \qoute{Amazon drafts social media content and press statements, and provides templates, all designed to help the police [...] make persuasive requests for surveillance data.}{selinger2022amazon}{98}
...
%    {tab:sel}
%    {
%        \SimpleTableHeader{Probleem}{Beschrijving}
%        \SimpleTableRow{Centralisatie}{Amazon verzamelt alle data en beslist wat ermee gebeurt - bedrijfsbelangen en staatsbelangen vloeien samen.}
%        \SimpleTableRow{Uitsluiting / "Wie hoort hier?"}{Bewaking stimuleert etnische en sociale profilering: wie "past" er wel of niet in de buurt?}
%        \SimpleTableRow{Schijninstemming}{Mensen lijken toestemming te geven, maar door machtsverschillen en sociale druk is die instemming leeg.}
%        \SimpleTableRow{RoboCop-effect}{De politie krijgt toegang tot beelden van burgers, waardoor een privaat bewakingssysteem ontstaat.}
%        \SimpleTableRow{Vervaging tussen bedrijf en politie}{Amazon levert kant-en-klare PR-teksten aan de politie - ze schrijven feitelijk mee aan publieke communicatie.}
%        \SimpleTableRow{Technologische laksheid}{Onduidelijke regels en weinig toezicht zorgen ervoor dat misbruik makkelijk blijft gebeuren.}
%        \SimpleTableRow{Panopticon-effect}{Goedkope camera's overal maken het normaal om buren in de gaten te houden en elkaar te corrigeren.}
%    }
%    {2}
    ...
    \editorsonly{Type bron: combinatie van gebruik, misbruik en gedrag rond smart home devices en videodeurbellen.}
...
%    \SimpleTable
%    {Aantal mensen die zijn gemonitord op basis van toestemmingstype \parencite{moh2023characterizing}}
%    {tab:moh1}
%    {
%        \SimpleTableHeader{Expliciet}{Implcitiet}{Geen toestemming}
%        \SimpleTableRow{$11+0+0=11$}{$11+0+4=15$}{$5+2+5=12$}
%    }

%    \SimpleTable
%    {Aantal mensen die hebben gemonitord op basis van toestemmingstype \parencite{moh2023characterizing}}
%    {tab:moh2}
%    {
%        \SimpleTableHeader{Expliciet}{Implcitiet}{Geen toestemming}
%        \SimpleTableRow{$10+1+0=11$}{$2+1+4=7$}{$1+0+2=3$}
%    }
